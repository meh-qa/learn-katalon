...
WebUI.verifyElementPresent(findTestObject('Login/Page_CURA Healthcare Service/Login Validation/Page_CURA Healthcare Service/p_Login failed Please ensure the username and password are valid'), 
    0)
